...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { des: @producto.des, nombre: @producto.nombre, precio: @producto.precio, vendedor_id: @producto.vendedor_id } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { des: @producto.des, nombre: @producto.nombre, precio: @producto.precio, vendedor_id: @producto.vendedor_id } }
