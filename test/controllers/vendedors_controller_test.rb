...
class VendedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendedor" do
    assert_difference('Vendedor.count') do
      post vendedors_url, params: { vendedor: { apellido: @vendedor.apellido, celular: @vendedor.celular, email: @vendedor.email, latitud: @vendedor.latitud, longitud: @vendedor.longitud, nombre: @vendedor.nombre } }
    end
  ...
  test "should update vendedor" do
    patch vendedor_url(@vendedor), params: { vendedor: { apellido: @vendedor.apellido, celular: @vendedor.celular, email: @vendedor.email, latitud: @vendedor.latitud, longitud: @vendedor.longitud, nombre: @vendedor.nombre } }
